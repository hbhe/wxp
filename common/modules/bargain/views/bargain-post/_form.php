...
<div class="bargain-post-form">
    ...
    <?php echo $form->field($model, 'rest_price')->textInput() ?>

    <?php echo $form->field($model, 'status')->dropDownList(\common\modules\bargain\models\BargainPost::getStatusOptionName()) ?>
